...
#define 	__RF24L01_TX_TEST__							//**@@ 暂不在意该宏 **@@//


/** 配置和选项定义 */
#define DYNAMIC_PACKET		1 		//1:动态数据包, 0:固定
#define FIXED_PACKET_LEN	32		//包长度
#define REPEAT_CNT			3		//重复次数(原代码为15)
#define RF_INIT_ADDR		0x34,0x43,0x10,0x10,0x55//(原代码为0x34,0x43,0x10,0x10,0x01)
#define RF_INIT_CH			120//射频信道(原代码为60)

/* 调用函数定义 */
#define drv_spi_read_write_byte(Data)     SPI_WriteReadByte(Data)
#define Delay_ms(ms)                      delay_ms(ms)
#define Delay_us(us)                      delay_us(us)

///* RF24L01硬件接口定义 */
#define RF24L01_CE_GPIO_BIT			P34
#define RF24L01_CS_GPIO_BIT			P35	//在原理图内为CSN
#define RF24L01_IRQ_GPIO_BIT		P37

///* 接口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )      (RF24L01_CE_GPIO_BIT = 1)
#define RF24L01_SET_CE_LOW( )       (RF24L01_CE_GPIO_BIT = 0)

#define RF24L01_SET_CS_HIGH( )      (RF24L01_CS_GPIO_BIT = 1)
#define RF24L01_SET_CS_LOW( )       (RF24L01_CS_GPIO_BIT = 0)

#define RF24L01_GET_IRQ_STATUS( )   RF24L01_IRQ_GPIO_BIT //IRQ状态
...
#define NOP_CMD         0xFF	//空操作，可以用来读状态寄存器
...
void NRF24L01_Config(uint8_t ifTX);//初始化
